...
function SponsorStatsBar({ sponsor }: { sponsor: any }) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
      {stats.map((s) => (
        <div key={s.label} className="bg-white rounded-xl p-4 text-center neu-card">
...
const SPONSOR_AGENTS = [
  {
    ...
    color: "#F59E0B",
    bgColor: "#FFFBEB",
    endpoint: "/api/sponsor/agents/ideator",
  },
  {
    name: "Hook & Script",
    ...
    color: "#EC4899",
    bgColor: "#FDF2F8",
    endpoint: "/api/sponsor/agents/hooks",
  },
  {
    name: "AI Reel Prompt",
    ...
    color: "#F97316",
    bgColor: "#FFF7ED",
    endpoint: "/api/sponsor/agents/reel-prompt",
    configKey: "quality",
    configOptions: [
  ...
  },
  {
    ...
    color: "#8B5CF6",
    bgColor: "#F5F3FF",
    endpoint: "/api/sponsor/agents/planner",
  },
  {
    name: "Analyst",
    ...
    color: "#10B981",
    bgColor: "#ECFDF5",
    endpoint: "/api/sponsor/agents/analyst",
  },
  {
    name: "DM Manager",
    ...
    color: "#3B82F6",
    bgColor: "#EFF6FF",
    endpoint: "/api/sponsor/agents/dm-manager",
  },
];
...
export default function SponsorPage() {
  ...
  async function scrapeSponsor() {
    ...
    setSponsor(null);
    try {
      const res = await fetch("/api/sponsor/scrape", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen pt-16 md:pt-0 md:pl-64">
      ...
      <main className="max-w-6xl mx-auto px-5 py-8 space-y-8">
        ...
        {/* Sponsor input */}
        <div className="bg-white rounded-2xl neu-raised p-6">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-3 rounded-xl bg-white neu-input text-sm focus:outline-none"
                disabled={scraping}
              />
            </div>
            <button
