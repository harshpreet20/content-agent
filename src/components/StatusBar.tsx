...
export default function StatusBar() {
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-3 px-4 py-2.5 bg-white rounded-2xl neu-raised-sm">
    ...
    <div className="flex flex-wrap items-center gap-2">
      {keys.map((key) => {
        ...
        return (
          <div
            key={key}
            className="flex items-center gap-2 px-3 py-2 bg-white rounded-xl neu-flat"
            title={
              isUnknown
                ? "Unknown"
                : isOk
