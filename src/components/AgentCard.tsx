...
export default function AgentCard({ name, description, icon, color, bgColor, endpoint, configOptions, configKey, defaultBody }: AgentCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl neu-card transition-all flex flex-col">
      {/* Header */}
      ...
      {(error || result) && (
        <div className="px-5 pb-4 flex-1">
          ...
          {result && (
            <>
              <div
                className="bg-white rounded-xl p-4 text-sm text-gray-700 leading-relaxed max-h-[500px] overflow-y-auto report-html neu-pressed"
