...
Opens on http://localhost:3001. Requires `PRODUCT_SERVICE_URL` (defaults to `http://localhost:4002`, i.e. product-service running via `npm run dev -w services/product-service`).
